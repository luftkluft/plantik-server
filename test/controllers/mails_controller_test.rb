...
class MailsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create mail" do
    assert_difference('Mail.count') do
      post mails_url, params: { mail: { from: @mail.from, text: @mail.text, theme: @mail.theme, to: @mail.to } }
    end
  ...
  test "should update mail" do
    patch mail_url(@mail), params: { mail: { from: @mail.from, text: @mail.text, theme: @mail.theme, to: @mail.to } }
